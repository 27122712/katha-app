...
import { User, Mail, Lock, Sparkles, Quote } from 'lucide-react';
    ...
    <div className="min-h-screen bg-slate-50 flex items-center justify-center p-6 py-20">
      <div className="max-w-xl w-full bg-white rounded-[2.5rem] shadow-xl p-10 border border-slate-100">
        ...
        <form action={handleSubmit} className="space-y-6">
             ...
             <div className="space-y-3">
               ...
               <div className="relative">
                 <textarea 
                   name="traits" 
                   required
                   placeholder="E.g. I am a tech enthusiast who loves electronics repair. I'm usually calm, witty, and deeply value my family's heritage." 
             ...
             <div className="space-y-3">
               ...
               <div className="relative">
                 ...
                 <textarea 
                   name="philosophy" 
                   required
                   placeholder="What is one piece of advice you want your loved ones to always remember?" 
          ...
          <button type="submit" className="w-full bg-slate-900 text-white py-5 rounded-2xl font-bold hover:bg-slate-800 transition shadow-lg hover:shadow-xl active:scale-95 transition-all">
            Register & Seed My Legacy
          </button>
        </form>
