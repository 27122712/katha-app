          ...
          <div className="flex justify-between items-center mb-10">
            <div className="flex gap-4">
              {user.email === "kathasystems@gmail.com" && (
                <Link
                  href="/admin"
                  className="flex items-center gap-2 bg-blue-50 border border-blue-100 px-4 py-2 rounded-xl text-blue-600 font-bold text-sm hover:bg-blue-600 hover:text-white transition shadow-sm"
                >
            ...
            <button
              ...
              className="flex items-center gap-2 text-slate-400 hover:text-red-500 font-bold text-sm transition"
            >
                  ...
                  <form action={handleUpload} className="space-y-6">
                    <div className="border-2 border-dashed border-slate-700 rounded-3xl p-8 text-center hover:border-blue-500 hover:bg-white/[0.02] transition-all group">
                      <input
                        ...
                        required
                        onChange={(e) =>
                          setUploadStatus(e.target.files?.[0]?.name || "")
                        }
                      />
                      <label
                        htmlFor="vault-file"
                      ...
                      >
                        ...
                        <p className="font-bold text-sm truncate max-w-[200px]">
                          {uploadStatus ? uploadStatus : "Archive a Memory"}
                        </p>
                        <p className="text-[10px] text-slate-500 mt-1 italic tracking-widest uppercase font-bold">
                          Max 5MB
                        </p>
                      </label>
                    </div>
                    <button
                      ...
                      className="w-full bg-blue-600 text-white py-4 rounded-2xl font-bold hover:bg-blue-500 transition shadow-lg flex items-center justify-center gap-2 disabled:opacity-50"
                    >
                      {isUploading ? "Securing..." : "Seal to Vault"}{" "}
                      <ArrowRight size={18} />
                    </button>
                  </form>
                </div>
                  ...
                  <div className="grid grid-cols-1 gap-3 max-h-[400px] overflow-y-auto pr-2 custom-scrollbar">
                    {files.map((file) => (
                      ...
                      >
                        ...
                        {/* Find this section in your map function */}
                        <div className="flex gap-2">
                          <a
                            href={file.file_url} // <--- CHANGE THIS to file.file_url
                            target="_blank"
                          ...
                          <a
                            href={`${file.file_url}?download=1`} // <--- Use Vercel Blob download query
        ...
        <header className="max-w-6xl mx-auto px-6 pt-32 pb-16 text-center animate-in fade-in duration-700">
          <div className="space-y-4 mb-14">
            ...
            <h1 className="text-5xl md:text-7xl font-extrabold leading-[1.1] tracking-tighter text-slate-900 max-w-4xl mx-auto">
              Preserve your <span className="text-blue-600 italic">wisdom</span>{" "}
              forever.
            </h1>
            <p className="text-xl text-slate-500 max-w-2xl mx-auto mb-8 font-medium leading-relaxed">
              Katha is a digital bridge to the future—preserving your thoughts
              and memories for the generations that follow.
            </p>
          </div>
          ...
          <div className="flex justify-center mb-20">
            <Link
              href="/login"
              className="bg-slate-900 text-white px-10 py-4 rounded-full font-bold text-sm hover:bg-slate-800 transition-all flex items-center gap-2.5 shadow-2xl shadow-slate-300 transform hover:scale-105 active:scale-95"
            >
            ...
            >
              {isMuted ? (
                <>
                  ...
                  <span className="text-[9px] font-black uppercase tracking-[0.2em] pr-1">
                    Enable Sound
                  </span>
                </>
              ) : (
        ...
        <div className="grid md:grid-cols-2 gap-16 items-center">
            ...
            <div className="bg-slate-50 rounded-[2.5rem] p-8 border border-slate-100 shadow-inner">
              <div className="space-y-4">
                ...
                <div className="bg-blue-600 p-4 rounded-2xl rounded-br-none shadow-sm max-w-[80%] ml-auto text-white">
                  <p className="text-sm">
                    "That year taught me that stories are the only things we
                    truly leave behind..."
                  </p>
                </div>
          ...
          <div className="space-y-6">
            ...
            <h2 className="text-4xl font-extrabold tracking-tight">
              Your <span className="text-blue-600">Thought Heirloom.</span>
            </h2>
            <p className="text-slate-500 text-lg leading-relaxed">
              Our AI learns the "Why" behind your choices. By seeding your mind
              with your philosophy, you ensure your guidance stays accessible
              forever. Don't just store files—talk to your future.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="bg-slate-50 py-20 border-y border-slate-100 text-center">
        <div className="max-w-4xl mx-auto px-6">
          ...
          <p className="text-xl text-slate-500 italic leading-relaxed">
            "Every person is a library. When they pass, the library burns. Katha
            is the fireproof vault that preserves your digital heritage."
          </p>
        </div>
      </section>
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          <div className="space-y-6">
            ...
            <p className="text-slate-500 leading-relaxed">
              We protect your legacy with advanced encryption. Your data is
              stored in a high-security environment designed to last for
              decades.
            </p>
            <ul className="space-y-3 text-sm font-bold text-slate-700">
              <li className="flex items-center gap-2">
                <Lock size={16} className="text-blue-600" /> Multi-layered
                AES-256 encryption.
              </li>
              <li className="flex items-center gap-2">
                <Shield size={16} className="text-blue-600" /> Metallic-grade
                cloud vault protection.
              </li>
            </ul>
          </div>
          <div className="bg-blue-50 rounded-[2rem] p-12 flex items-center justify-center border border-blue-100 relative">
            <div className="w-32 h-40 bg-blue-600 rounded-xl shadow-2xl flex items-center justify-center relative z-10">
...
export default function Home() {
  return (
    <Suspense
      fallback={
        <div className="p-20 text-center text-slate-400 font-mono text-xs uppercase tracking-[0.3em]">
          Opening Vault...
        </div>
      }
    >
